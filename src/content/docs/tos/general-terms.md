...
```mermaid
graph TD
    A[Phát sinh tranh chấp] --> B[Trao đổi trực tiếp]
    B -->|Không đạt| C[Hòa giải qua trung gian]
    C -->|Không đạt| D[Đối thoại cấp cao]
    D -->|Không đạt| E[Giải quyết theo pháp luật]
